...
import com.example.usermodule.Security.JWT.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/signup/**", "/login", "/now/**", "/post/**","/users/**","/user/**").permitAll()
                        .requestMatchers("/admin/**").hasRole("ADMIN")
                        .requestMatchers("/use/**", "/newsfeeds/**").hasRole("USER")
                        .anyRequest().denyAll())
